...
<ol class = 'scroll'>
<?php 
$vypis = mysql_query("select jmeno, id from clanky where autor = '".id_uzivatele."' order by id desc limit 15");
...
$q = mysql_query("select link from clanky");
