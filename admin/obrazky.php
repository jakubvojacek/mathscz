...
$vypis = mysqli_query(DATABASE::getDb(), "select id from obrazky");

$pocet_obrazku = mysqli_num_rows($vypis);
...
$vypis = mysqli_query(DATABASE::getDb(), "select * from obrazky order by id desc limit $pocatek, 5");
