...
window.onload = function(){
    if (zXmlHttp.isSupported()){
        ...
        email.onchange = validateField;
        email.onkeyup = validateField;
        ...
        heslo.onchange = validateField;
        heslo.onkeyup = validateField;
        var heslo2 = document.getElementById("heslo_2");
        heslo2.onchange = validateField;
        heslo2.onkeyup = validateField;
        validateField(1);
        }
    }
