...
mysql_query("insert into komentare(autor, predmet, text, clanek, datum, id_autora, ip) values('$autor','$predmet','$text','$id_clanku','$datum', '$id_autora', '$ip')") or die(mysql_error());  
